...
const AddListButton = () => {
  return (
    <button className='group bg-[rgb(0,101,224)] group-hover:bg-[rgb(89,156,238)] transition-all duration-150 p-[8px_20px] rounded-[4px] block ml-2' onClick={() => {location.href='https://form.jotform.com/221731520681449'}}>
